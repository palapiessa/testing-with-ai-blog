...
My next step? Train an open-source model to interact with an app and see if it can then generate meaningful test scripts. Will it work? Let’s find out together.